...
def ajouter_service():
    ...
    titre = localisation = description = cout = categorie = ''
    statut = 1
    class_titre = class_localisation = class_description = class_cout = class_categorie = class_photo = ''
    ...
    try:
        with bd.creer_connexion() as conn:
            ...
            class_titre = class_localisation = class_description = class_cout = class_nom_photo = ''
